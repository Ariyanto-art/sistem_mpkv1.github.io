                    ...
                    <div class="container-fluid px-4">
                        ...
                        <table class="table table-bordered text-center data">
                            ...
                            if (isset($_POST['cetak']))
                                {
                                    $cari_data = $_POST['view'];
                                    $tampil = mysqli_query ($koneksi, "SELECT * FROM pbmpk WHERE nama LIKE '%$cari_data%' OR rt LIKE '%$cari_data%' order by id_pb desc");
                                }
                                else
                                {
                                    $tampil = mysqli_query($koneksi, "SELECT * FROM pbmpk order by id_pb desc");
                                }
