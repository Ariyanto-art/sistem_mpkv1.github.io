            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <p style="font-family: times new roman; font-size: 35px;" class="mt-1 text-center">DATA DHUAFA RW006</p>
                        <table class="table table-bordered text-center ">
                            ...
                            <?php
                            $no = 1;
                            $tampil = mysqli_query($koneksi, "SELECT * FROM pbmpk WHERE alasan = 'Dhuafa'");
