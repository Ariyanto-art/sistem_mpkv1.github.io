                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion"><!-- Awal Nav-->
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="kas_masuk.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-file"></i></div>
                                Laporan Kas
                            </a>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ul class="nav nav-tabs">
                          <li class="nav-item">
                            <a class="nav-link" href="lap_mpk_kas.php">MPK</a>
                          </li>
                          <li class="nav-item">
                            ...
                            <div class="row">
                                ...
                                <div class="card">
                                  <div class="card-body">
                                    ...
                                    <?php
                                        $kas_masuk = mysqli_query($koneksi, "SELECT SUM(kas_masuk) AS hasil FROM simpanan WHERE bank='Bank Sampah'");
                              ...
                              <div class="col-sm-4 mb-1">
                                <div class="card">
                                  <div class="card-body">
                                    ...
                                    <?php
                                        $kas_keluar = mysqli_query($koneksi, "SELECT SUM(kas_keluar) AS hasil FROM simpanan WHERE bank='Bank Sampah'");
                        ...
                        <div class=" table-responsive mt-2">
                            <table class="table table-bordered text-center">
                                ...
                                $no = 1;
                                $no_kwitansi = 1;
                                $tampil = mysqli_query($koneksi, "SELECT * FROM simpanan WHERE bank='Bank Sampah' order by id_kas desc");
