                    ...
                    <div class="container-fluid px-4">
                            ...
                            <div class="row">
                                ...
                                <div class="card">
                                  <div class="card-body">
                                    ...
                                    <?php
                                        $kas_masuk = mysqli_query($koneksi, "SELECT SUM(kas_masuk) AS hasil FROM simpanan WHERE bank='Dhuafa'");
                              ...
                              <div class="col-sm-4 mb-1">
                                <div class="card">
                                  <div class="card-body">
                                    ...
                                    <?php
                                        $kas_keluar = mysqli_query($koneksi, "SELECT SUM(kas_keluar) AS hasil FROM simpanan WHERE bank='Dhuafa'");
                        ...
                        <div class=" table-responsive mt-2">
                            <table class="table table-bordered text-center">
                                ...
                                $no = 1;
                                $no_kwitansi = 1;
                                $tampil = mysqli_query($koneksi, "SELECT * FROM simpanan WHERE bank='Dhuafa' order by id_kas desc");
