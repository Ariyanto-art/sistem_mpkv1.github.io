                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ul class="nav nav-tabs">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" href="yatim.php">Yatim</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="piatu.php">Piatu</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link active" href="yatim_piatu.php">Yatim Piatu</a>
                          </li>
                        </ul>
                        <div class="table-responsive mt-2">
                            <table class="table table-bordered text-center ">
                                ...
                                <?php
                                $no = 1;
                                $tampil = mysqli_query($koneksi, "SELECT * FROM datawarga WHERE alasan = 'Yatim Piatu'");
                        ...
                        <form method="post" action="../cetak/cetak_yatim_piatu.php" target="_blank">
